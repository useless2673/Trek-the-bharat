...
$(document).ready(function () {
  $(".log").mouseenter(function () {
    ...
    $(document).ready(function () {
      let o = document.getElementById("toggleButton"),
        s = document.getElementById("icon"),
        c = localStorage.getItem("theme") || "light";
      function e(o) {
        "dark" === o
          ? ($("body").addClass("dark-mode"),
            ...
            $(".log").attr(
              "src",
              "https://thumbs.dreamstime.com/b/user-icon-linear-gray-background-106603449.webp"
            ),
            ...
            $(".second-custom-carousel-card").css(
              "background",
              "rgb(44,44,42)"
            ),
          ...
          : ($("body").removeClass("dark-mode"),
            ...
            $(".log").attr(
              "src",
              "https://pic.onlinewebfonts.com/thumbnails/animations_258083.svg?width=12"
            ),
            $(".textcolor").css("color", "transparent"),
            $(".second-custom-carousel-card").css(
              "background",
              "rgb(249,249,249)"
            ),
      ...
      e(c),
        o.addEventListener("click", () => {
          let o = $("body").hasClass("dark-mode") ? "light" : "dark";
          e(o), localStorage.setItem("theme", o);
        });
    });
}),
  $(document).ready(function () {
